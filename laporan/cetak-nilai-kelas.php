...
<div class="block-flat no-padding">
	<div class="content">
				...
				<?php 
					if (isset($_POST['cetak-nilai'])) {
						...
						$sql 		=	mysql_query("SELECT siswa.siswa_nama, pelajaran.pelajaran_nama, nilai.nilai_poin, jenis.jenis_nama, semester.semester_nama, tahun.tahun_nama, kelas.kelas_id, kelas.kelas_nama 
													...
													WHERE kelas.kelas_id=$kelas AND jenis.jenis_id=$jenis AND semester.semester_id=$semester AND tahun.tahun_id=$tahun AND pelajaran.pelajaran_id=$pelajaran
		...
		<div class="col-sm-3">
			<?php 
				$guru 	=	mysql_query("SELECT *, pelajaran.pelajaran_nama FROM guru 
		...
		<hr/>
		<a href="../dashboard.php?cetak=laporan-nilai-kelas" cls='btn'><i class='fa fa-reply'></i> Kembali </a>
