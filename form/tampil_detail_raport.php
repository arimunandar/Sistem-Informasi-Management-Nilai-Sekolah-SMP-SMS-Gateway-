		...
		<table class="no-border blue">
			...
			<form role="form" method="post" />
				<?php
						...
						$sql = mysql_query("SELECT nilai.nilai_id, siswa.siswa_nama, pelajaran.pelajaran_nama, nilai.nilai_poin,
				...
				<tr>
					...
					<td class="text-center" width="17%">
						<a href="?nilai=Raport&&edit-raport=<?php echo $data['nilai_id']; ?>" class="btn btn-warning"><span class="fa fa-edit"></span> Edit</a>
						<a href="?nilai=Raport&&tampil=Raport&&del-raport=<?php echo $data['nilai_id']; ?>" class="btn btn-danger"><span class="fa fa-trash"></span> Delete</a>
					</td>
				</tr>
				<?php 
					$no++;  
