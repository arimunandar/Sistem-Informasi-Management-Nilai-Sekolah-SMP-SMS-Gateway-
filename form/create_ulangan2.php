<div class="block-flat">
	<div class="header">							
		<h3>Input Data Nilai Ulangan 2</h3>
	</div>
	<div class="content">
		<form role="form" method="POST"> 
			...
			<button class="btn btn-primary" type="submit" name="create-nilai"><span class="fa fa-plus"></span> Tambah Nilai Ulangan 2</button>
		</form>
	</div>
</div>
	...
	<div class="content">
		<table class="no-border blue">
			...
			<form role="form" method="post" />
				...
				?>		
				<tr>
					<td colspan="3" align="right" valign="baseline"><button type="submit" class="btn btn-success" name="ulangan2-proses"><span class="fa fa-gear"></span> Proses</button></td>
				</tr>
			</form>
			<?php 
				}
