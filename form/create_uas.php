	...
	<div class="content">
		<table class="no-border blue">
			...
			<form role="form" method="post" />
				...
				?>		
				<tr>
					<td colspan="3" align="right" valign="baseline"><button type="submit" class="btn btn-success" name="uas-proses"><span class="fa fa-gear"></span> Proses</button></td>
				</tr>
			</form>
			<?php 
				}
