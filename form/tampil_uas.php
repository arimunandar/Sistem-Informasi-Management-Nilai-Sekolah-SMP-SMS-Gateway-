...
<div class="block-flat no-padding">
	<div class="content">
			...
			<form role="form" method="post" />
				...
				<tr>
					...
					<td class="text-center" width="17%">
						<a href="?nilai=UAS&&edit-uas=<?php echo $data['nilai_id']; ?>" class="btn btn-warning"><span class="fa fa-edit"></span> Edit</a>
						<a href="?nilai=UAS&&tampil=UAS&&del-uas=<?php echo $data['nilai_id']; ?>" class="btn btn-danger"><span class="fa fa-trash"></span> Delete</a>
					</td>
				</tr>
				<?php 
					$no++;  
		...
		<hr/>
		<a href="?nilai=UAS" class="btn btn-success"><span class="fa fa-reply"></span> Back</a>
...
<div class="block-flat">
	...
	<div class="content">
		<form role="form" method="POST"> 
			...
			<a href="?nilai=UAS" class="btn btn-success"><span class="fa fa-reply"></span> Kembali</a>
			<button class="btn btn-primary" type="submit" name="cek-nilai"><span class="fa fa-search"></span> Cari Nilai UAS</button>
		</form>
	</div>
</div>
<?php
