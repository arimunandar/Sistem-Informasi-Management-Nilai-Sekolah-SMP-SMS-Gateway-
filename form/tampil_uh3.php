...
<div class="block-flat no-padding">
	<div class="content">
			...
			<form role="form" method="post" />
				...
				<tr>
					...
					<td class="text-center" width="17%">
						<a href="?nilai=Ulangan3&&edit-ulangan3=<?php echo $data['nilai_id']; ?>" class="btn btn-warning"><span class="fa fa-edit"></span> Edit</a>
						<a href="?nilai=Ulangan3&&tampil=Ulangan3&&del-ulangan3=<?php echo $data['nilai_id']; ?>" class="btn btn-danger"><span class="fa fa-trash"></span> Delete</a>
					</td>
				</tr>
				<?php 
					$no++;  
		...
		<hr/>
		<a href="?nilai=Ulangan3" class="btn btn-success"><span class="fa fa-reply"></span> Back</a>
		<a href="?catak-uh3=<?php echo $data['nilai_id']; ?>" class="btn btn-info"><span class="fa fa-print"></span> Cetak</a>
	</div>
</div>
<?php 
	}else {
...
<div class="block-flat">
	<div class="header">							
		<h3>Cari Data Nilai Ulangan 3</h3>
	</div>
	<div class="content">
		<form role="form" method="POST"> 
			...
			<a href="?nilai=Ulangan3" class="btn btn-success"><span class="fa fa-reply"></span> Kembali</a>
			<button class="btn btn-primary" type="submit" name="cek-nilai"><span class="fa fa-search"></span> Cari Nilai Ulangan 3</button>
		</form>
	</div>
</div>
<?php
